                                        ...
                                        <div class="easyzoom-style">
                                            <div class="easyzoom easyzoom--overlay">
                                                <a href="{{ asset($subImage->image)}}">
                                                    <img src="{{ asset($subImage->image)}}" styte="height:450px;" alt="#">
                                                </a>
                                            </div>
                                    ...
                                    @foreach($subImages as $subImage)
                                        <div class="swiper-slide">
                                            <div class="product-details-small-img">
                                                <img src="{{ asset($subImage->image) }}" styte="height:100px;" alt="Product Thumnail">
                                            </div>
                                        </div>
                                    @endforeach
                                    <div class="swiper-slide">
            ...
            <div class="tab-content">
                <div id="des-details1" class="tab-pane active">
                    <div class="product-description-content text-center">
                        <p data-aos="fade-up" data-aos-delay="200">{!! $product->sort_description !!} </p>
                    </div>
                </div>
