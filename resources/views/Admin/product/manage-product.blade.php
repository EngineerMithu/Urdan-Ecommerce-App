                                    ...
                                    <div class="ibox-body">
                                        <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
                                            ...
                                            <tr>
                                                ...
                                                <td align="center">
                                                    <img src="{{asset($product->image)}}" height="40%"; width="40%"; alt="Not Found!" />
                                                </td>
                                                <td>{{$product->status==1 ? 'Published':'Unpublished'}}</td>
                                                <td>{{$product->created_at->diffForHumans()}}</td>
                                                <td>
                                                    <a href="{{ route('edit-product',['id' =>$product->id]) }}" class="fa fa-edit btn btn-primary"> </a><br><br>
                                                    <a href="{{ route('delete-product',['id' =>$product->id]) }}" onclick="return confirm('Are you sure to delete?')" class="fa fa-trash btn btn-danger"> </a>
                                                </td>
                                            </tr>
                                                @endforeach
                                            </tbody>
