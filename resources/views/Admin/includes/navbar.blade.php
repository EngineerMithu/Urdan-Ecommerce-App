<nav class="page-sidebar" id="sidebar">
    <div id="sidebar-collapse">
        <div class="admin-block d-flex">
            <div>
                <img src=" {{ asset('/admin_assets/') }}/assets/img/admin-avatar.png" width="45px" />
            </div>
        ...
        <ul class="side-menu metismenu">
            ...
            <li>
                ...
                <ul class="nav-2-level collapse">
                    <li>
                        <a href="{{ route('add-subCategory') }}">Store</a>
                    </li>
                    <li>
            ...
            <li>
                ...
                <ul class="nav-2-level collapse">
                    <li>
                        <a href="{{ route('add-brand') }}">Store</a>
                    </li>
                    <li>
            ...
            <li>
                ...
                <ul class="nav-2-level collapse">
                    <li>
                        <a href="{{ route('add-unit') }}">Store</a>
                    </li>
                    <li>
                        <a href="{{ route('manage-unit') }}">Manage</a>
                    </li>
                </ul>
            </li>
                ...
                <ul class="nav-2-level collapse">
                    <li>
                        <a href="{{ route('add-product') }}">Store</a>
                    </li>
                    <li>
