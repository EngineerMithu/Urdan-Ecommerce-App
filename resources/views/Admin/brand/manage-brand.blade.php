                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
                                            ...
                                            @foreach($brands as $brand)
                                                <tr>
                                                    ...
                                                    <td align="center">
                                                        <img src="{{asset($brand->image)}}" height="40%"; width="40%"; alt="Not Found!" />
                                                    </td>
                                                    <td>{{$brand->status==1 ? 'Published':'Unpublished'}}</td>
                                                    <td>{{$brand->created_at->diffForHumans()}}</td>
                                                    <td>
                                                        <a href="{{ route('edit-brand',['id' =>$brand->id]) }}" class="fa fa-edit btn btn-primary"> </a><br><br>
                                                        <a href="{{ route('delete-brand',['id' =>$brand->id]) }}" onclick="return confirm('Are you sure to delete?')" class="fa fa-trash btn btn-danger"> </a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                            </tbody>
