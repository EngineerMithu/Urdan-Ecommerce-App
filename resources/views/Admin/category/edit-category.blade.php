                        ...
                        <div class="card-body">
                            <form action="{{ route('update-category') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <textarea name="description" class="form-control" cols="30" rows="5" required >{{ $category->description }}</textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <label><input type="radio" name="status" {{ $category->status==1 ? 'checked': '' }} value="1" required /> Published</label>
                                        <label><input type="radio" name="status" {{ $category->status==0 ? 'checked': '' }} value="0" required /> Unpublished</label>
                                    </div>
                                </div>
                                <div class="form-group row">
